...
class read_FOdata {
  ...
  public:
    ...
    void read_in_freeze_out_data(
        std::vector<FO_surf> &surf_ptr, std::string surface_filename);
    void read_in_chemical_potentials(
