...
int main() {
    ...
    for (int i = 0; i < 11; i++) {
        check << scientific << setw(18) << setprecision(8) << i - 5 << "  "
              << hist[i] << endl;
    }
    check.close();
    ...
    double sample_chi_4 =
        (mu_4 - 4. * mu_1 * mu_3 + 6. * mu_1 * mu_1 * mu_2
         - 3. * mu_1 * mu_1 * mu_1 * mu_1);

    cout << scientific << setw(18) << setprecision(8)
         << "check: mean = " << sample_chi_1 << ", chi_2 = " << sample_chi_2
         << ", chi_3 = " << sample_chi_3 << ", chi_4 = " << sample_chi_4
         << endl;
}
