...
PearsonDistribution::PearsonDistribution(
    double chi_1_in, double chi_2_in, double chi_3_in, double chi_4_in) {
...
void PearsonDistribution::resetDistribution(
    double chi_1_in, double chi_2_in, double chi_3_in, double chi_4_in) {
    chi_1 = chi_1_in;
    chi_2 = chi_2_in;
    chi_3 = chi_3_in;
...
double PearsonDistribution::rand() { return (sampleUsingPDFAndEnvelopFunc()); }

double PearsonDistribution::rand(
    double chi_1, double chi_2, double chi_3, double chi_4) {
