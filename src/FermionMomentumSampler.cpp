...
double FermionMomentumSampler::CDF_0(
...
double FermionMomentumSampler::CDF_1(
    const double Etilde, const double mtilde) const {
    double res = 0.;
    double sign = 1.;
    for (int n = 0; n < trunc_order_; n++) {
...
double FermionMomentumSampler::CDF_2(
    const double Etilde, const double mtilde) const {
    double res = 0.;
    for (int n = 0; n < trunc_order_; n++) {
        int n1 = n + 1;
